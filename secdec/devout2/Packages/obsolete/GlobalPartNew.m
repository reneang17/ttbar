...
2 qT^(2ep)/Omega[d-3] (*azi averange*) * 
(4 Pi)^4 (e^EulerGamma/(4Pi))^(2ep) (*Coupling*)*
qT^(-2-4ep)(*scale qT]*) *
(2 Pi)^(d/2-1) (*Fourier transform*) * 
(Omega[d-4] Omega[d-3])/(2Pi)^(2d-2) (*azimuth of k and l*) 
For simplicity, we set qT=1.
This is combined re-introduced just before numerical integration. Omega[d_] := 2 Pi^((d + 1)/2)/Gamma[(d + 1)/2]"
