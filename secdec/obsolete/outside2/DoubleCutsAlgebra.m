...
Naminginput=DoubleCuts/.{e_. (Subscript[T, a_]\[CenterDot]Subscript[T, b_])**(Subscript[T, c_]\[CenterDot]Subscript[T, d_])+f_.:> StringJoin["int",ToString[a],ToString[b],ToString[c],ToString[d]],
                          -CA Subscript[T, a_]\[CenterDot]Subscript[T, b_]:>StringJoin["int",ToString[a],ToString[b]]};
