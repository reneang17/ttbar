...
dem5=(x5*(2-x5))^(-1/2);
dem56=(x5*(2-x5))^(-1/2)(x6*(2-x6))^(-1);

reptemp1={
     WE0[1,bpoint__,b5_,b6_]:>
     WSubs1[{bpoint,reg21*b5/2+reg22*(2-b5)/2,reg31*(b6-1)+reg32*(1-b6)},WauxList[[2]]]*dem5,
     WE0[2,bpoint__,b5_,b6_,cvec_]:>
     WDeri1[{bpoint,reg21*b5/2+reg22*(2-b5)/2,reg31*(b6-1)+reg32*(1-b6)},cvec,WauxList[[2]]]*dem5
        };
reptemp3={
		 WE0[3,bpoint__,b5_,b6_]:>
     WSubs2[{bpoint,reg21*b5/2+reg22*(2-b5)/2,reg31*(b6-1)+reg32*(1-b6)},WauxList[[2]]]*dem56,
		 WE0[4,bpoint__,b5_,b6_,cvec_]:>
     WDeri2[{bpoint,reg21*b5/2+reg22*(2-b5)/2,reg31*(b6-1)+reg32*(1-b6)},cvec,WauxList[[2]]]*dem56
        };
