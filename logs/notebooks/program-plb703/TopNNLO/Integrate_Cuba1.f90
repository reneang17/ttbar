! This file is compatible with Cuba 1.x
  ...
  subroutine Cuba(method, ndim, ncomp, integrand, results, epsrel)
    ...
    if ( method == Cuba_VEGAS ) then
       ...
       call vegas(ndim, ncomp, integrand, &
            epsrel, Cuba_epsabs, Cuba_verbose + Cuba_smooth, Cuba_mineval, Cuba_maxeval, &
            Cuba_nstart, Cuba_nincrease, &
       ...
       call suave(ndim, ncomp, integrand, &
            epsrel, Cuba_epsabs, Cuba_verbose + Cuba_last + Cuba_smooth, &
            Cuba_mineval, Cuba_maxeval, &
            Cuba_nnew, Cuba_flatness, &
       ...
       call divonne(ndim, ncomp, integrand, &
            epsrel, Cuba_epsabs, Cuba_verbose, Cuba_mineval, Cuba_maxeval, &
            Cuba_key1, Cuba_key2, Cuba_key3, Cuba_maxpass, &
       ...
       call cuhre(ndim, ncomp, integrand, &
            epsrel, Cuba_epsabs, Cuba_verbose + Cuba_last, Cuba_mineval, Cuba_maxeval, &
            Cuba_key, &
            nregions, neval, fail, results, error, prob)
