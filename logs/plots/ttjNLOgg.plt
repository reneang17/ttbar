...
!sed 1,+9d '../runs-topqT++limited/hist_real_ggNNLO_logqT.dat' > \
           /tmp/topqT++NLO.dat

##########################
set terminal pngcairo enhanced solid size 500, 550 font "Helvetica, 10"
set output 'ttjNLOgg.png'
set multiplot
#set bars small
...
#  \
#  '<paste /tmp/ptPWGLO.dat ../runs-powheg/ptPWGNLOgg.dat'  \
...
plot \
   1 lt 0 t '',\
   '<paste  /tmp/topqT++NLO.dat ../runs-powheg/ptPWGNLOgg.dat /tmp/ptPWGLO.dat'  \
