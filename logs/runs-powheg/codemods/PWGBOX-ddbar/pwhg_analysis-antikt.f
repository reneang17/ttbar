...
c log(pt) of the pair
         bsz(26)=0.2d0
         call pwhgbookup(26+numplots*ncut,'ttbar logpt logpt(ttb)>'//ttbcut
     $        ,'LOG',bsz(26),0.0d0,4.0d0)
...
c pt of the pair
         call pwhgfill(26+numplots*ncut,log(ptttbar),dsig/bsz(26))
c pt of the pair zoom
