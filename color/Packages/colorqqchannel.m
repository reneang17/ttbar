 ...
 *                                                                            *
 ******************************************************************************)
Print["colorqqchannel Package"];


BeginPackage["colorqqchannel`",{"Symbols`"}]
...
cket = {deltaF[Subscript[a, 1], Subscript[a, 2]] deltaF[Subscript[a, 
     3], Subscript[a, 4]], 
   T[c, Subscript[a, 2], Subscript[a, 1]] T[c, Subscript[a, 3], 
     Subscript[a, 4]]};
cbra = {deltaF[Subscript[c, 1], Subscript[c, 2]] deltaF[Subscript[c, 
     3], Subscript[c, 4]], 
   T[a, Subscript[c, 4], Subscript[c, 3]] T[a, Subscript[c, 1], 
     Subscript[c, 2]]};
...
T[c_, a_, b_, 1] := T[c, a, b]
T[c_, a_, b_, 2] := -T[c, b, a]
...
Colourqq[inp_] := Module[{tmp, reslocal, mtmp, in},
  ...
  mtmp = ConstantArray[0, {2, 2}];
  Do[
   reslocal = 1/Nc in cbra[[imain]] cket[[jmain]];
