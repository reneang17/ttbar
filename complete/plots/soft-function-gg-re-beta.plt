...
set terminal pngcairo enhanced dashed size 21in, 15in 
...
set yrange [-230:1100]
#set yrange [-230:130]
set label 2 "{/Symbol q} = {/Symbol p}/4" at graph 0.10, 0.50 left font "Helvetica, 16"
...
plot   \
  ...
  '<paste ../tabletad11gg.dat ../tablebub11gg.dat ../table2cut11gg.dat ../oldtable1cutgg.dat'  \
  u 1:($4+$8+$28+$34):($29) w err ls 4 t '{/Symbol e}^0 bare',\
  '../tablealtgg.dat' u 1:2:3 w err ls 4 pt 6 t '',\
  '' u 1:2 w l ls 4 t '',\
  '<paste ../tablealtgg.dat ../common/tablerge2ep0gg.dat' u 1:($2+$15):3 w err ls 3 pt 6 t '{/Symbol e}^0 renormalized',\
  '' u 1:($2+$15) w l ls 3 t ''


replot \
  '../common/tablergegg.dat' u 1:(-$2) w l ls 5 t '1/{/Symbol e}^2 RGE',\
  '../common/tablergegg.dat' u 1:(-$3) w l ls 2 t '1/{/Symbol e} RGE'
...
plot \
  '../common/tablergegg.dat' u 1:(-$4) w l ls 5 t '',\
...
plot \
  '../common/tablergegg.dat' u 1:(-$6) w l ls 5 t '',\
...
plot \
  '../common/tablergegg.dat' u 1:(-$8) w l ls 5 t '',\
...
plot \
  '../common/tablergegg.dat' u 1:(-$10) w l ls 5 t '',\
...
plot \
  '../common/tablergegg.dat' u 1:(-$12) w l ls 5 t '',\
